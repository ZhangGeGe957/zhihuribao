...
- (void)getNetworkModel:(NSNotification *)getModel {
    ...
    [self.temporaryArray addObject:self.storiesTitle];
    [self.temporaryArray addObject:self.storiesHint];
    [self.temporaryArray addObject:self.storiesImages];
    [self.temporaryArray addObject:self.storiesUrl];
    ...
    [self.temporaryArray addObject:self.storiesId];
